...
<div class="analytics-container analytics-page">
    ...
    <div class="report-controls">
        ...
        <div style="margin-top: 15px; padding: 10px; background-color: #e8f4fd; border-radius: 4px; border-left: 4px solid #3498db;">
            <strong>Report Period:</strong> <?php echo $displayStartDate; ?> to <?php echo $displayEndDate; ?>
            <br>
    ...
    <div class="stats-grid">
        ...
        <div class="stat-card">
            ...
            <div class="stat-value">₱<?php echo number_format($transactionStats['avg_transaction_value'] ?? 0, 2); ?></div>

...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Nov 25, 2025 at 05:32 AM
...
(1, 'Aspirin', 9, 2.50, NULL, 'Other', 2, '2025-11-24 12:32:07', 'box'),
...
(6, 'Gunting', 20, 0.00, NULL, 'Equipment', 25, '2025-11-25 05:22:05', 'pcs');
...
INSERT INTO `services` (`id`, `service_name`, `description`, `service_price`, `category`, `service_type`, `inventory_id`, `quantity_needed`, `created_at`) VALUES
(1, 'General Check-up', 'A standard health consultation and physical examination.', 500.00, NULL, 'individual', NULL, 1, '2025-08-09 11:46:38'),
(2, 'Dental Cleaning', 'Routine dental hygiene and plaque removal.', 800.00, NULL, 'individual', NULL, 1, '2025-08-09 11:46:38'),
(3, 'Tooth Extraction', 'Removal of a single tooth.', 1200.00, NULL, 'individual', NULL, 1, '2025-08-09 11:46:38'),
(18, 'CBC (Complete Blood Count)', 'Laboratory request for CBC to assess overall health and detect disorders such as anemia or infection.', 150.00, NULL, 'individual', NULL, 1, '2025-10-13 06:57:56'),
(19, 'Urine Analysis (Urinalysis)', 'Diagnostic urine test to check for signs of urinary infection or metabolic conditions.', 100.00, NULL, 'individual', 5, 1, '2025-10-13 06:57:56'),
(20, 'Stool Examination', 'Laboratory analysis of stool sample to detect digestive tract issues or parasites.', 120.00, NULL, 'individual', NULL, 1, '2025-10-13 06:57:56'),
(21, 'Blood Sugar Test (RBS/FBS)', 'Finger-prick glucose test to check for abnormal sugar levels.', 80.00, NULL, 'individual', NULL, 1, '2025-10-13 06:57:56'),
(22, 'Laboratory Request Form Processing', 'Processing and issuance of lab request forms for partner health facilities.', 50.00, NULL, 'individual', NULL, 1, '2025-10-13 06:57:56'),
(23, 'Physical Health Check-Up', 'Basic physical examination to assess student health and fitness status.', 50.00, NULL, 'individual', NULL, 1, '2025-10-13 06:57:56'),
(24, 'Medical Assessment for Activity Clearance', 'Evaluation for participation in sports, PE, or school activities.', 80.00, NULL, 'individual', NULL, 1, '2025-10-13 06:57:56'),
(25, 'OJT / Internship Medical Evaluation', 'Medical evaluation required for internship or field training.', 100.00, NULL, 'individual', NULL, 1, '2025-10-13 06:57:56'),
(26, 'Blood Pressure Check', 'Routine blood pressure monitoring.', 20.00, NULL, 'individual', NULL, 1, '2025-10-13 06:57:56'),
(27, 'Vital Sign Follow-Up Monitoring', 'Scheduled follow-up for students under observation.', 20.00, NULL, 'individual', NULL, 1, '2025-10-13 06:57:56'),
(28, 'Post-Treatment Health Check', 'Follow-up evaluation after medication or treatment.', 30.00, NULL, 'individual', NULL, 1, '2025-10-13 06:57:56'),
(29, 'Health Certificate Issuance', 'Issuance of official health clearance or consultation certificate.', 50.00, NULL, 'individual', NULL, 1, '2025-10-13 06:57:56'),
(30, 'Medical Referral Endorsement', 'Referral documentation for external hospital or lab processing.', 50.00, NULL, 'individual', NULL, 1, '2025-10-13 06:57:56'),
(32, 'Demo Promo', 'Package contents: 26,21,31', 150.00, NULL, 'package', NULL, 1, '2025-11-18 10:11:52'),
(33, 'Demo Promo 2', 'Package contents: 18,29,19', 199.00, NULL, 'package', NULL, 1, '2025-11-18 11:23:36'),
(34, 'First Aid Kit', 'For First aid only. ', 15.00, NULL, 'individual', 2, 1, '2025-11-18 20:22:41'),
(37, 'General Check-Up + First Aid Kit', 'Package contents: 34,1', 499.00, NULL, 'package', NULL, 1, '2025-11-18 20:36:35'),
(38, 'Tuli', '', 200.00, NULL, 'individual', 4, 1, '2025-11-20 18:43:42'),
(40, 'Tryan ra kung mo work na', 'Tryan ra', 400.00, NULL, 'individual', 3, 1, '2025-11-20 18:57:48'),
(42, 'Lipid Profile Tests (Fasting)', '', 900.00, 'Clinical Chemistry', 'individual', NULL, 1, '2025-11-23 18:14:15'),
(43, 'Sodium', '', 400.00, 'Electrolytes', 'individual', NULL, 1, '2025-11-23 19:20:14'),
(44, 'Potassium', '', 400.00, 'Electrolytes', 'individual', NULL, 1, '2025-11-23 19:20:39'),
(45, 'Chloride', '', 400.00, 'Electrolytes', 'individual', NULL, 1, '2025-11-23 19:20:56'),
(46, 'Chest PA/AP', '', 450.00, 'X-Ray Examinations', 'individual', NULL, 1, '2025-11-23 19:21:33'),
(47, 'Dengue Rapid Test', '', 1200.00, 'Immunology/Serology', 'individual', NULL, 1, '2025-11-23 19:22:28'),
(48, 'Whole Abdomen', '', 1800.00, 'Ultrasound Examinations', 'individual', 1, 1, '2025-11-24 04:13:01'),
(49, 'Student Promo', 'Package contents: 18,19', 599.00, '', 'package', NULL, 1, '2025-11-24 04:14:47'),
(50, 'Blood Sugar + First Aid', 'Package contents: 21,34', 200.00, 'Bundle', 'package', NULL, 1, '2025-11-24 12:24:24'),
(51, 'Blood Sugar + First Aid', 'Package contents: 21,34', 200.00, 'Bundle', 'package', NULL, 1, '2025-11-24 12:26:20'),
(52, 'Final Demo', 'Package contents: 26,21', 159.00, 'Bundle', 'package', NULL, 1, '2025-11-24 12:27:58');
...
(37, 16, '2025-11-24 00:00:00', 'Anual Check Up', 'Whole Abdomen', '[]', 1800.00, '2025-11-24 12:32:07');

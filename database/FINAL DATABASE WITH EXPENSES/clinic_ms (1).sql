...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Dec 03, 2025 at 11:28 AM
...
INSERT INTO `expenses` (`id`, `expense_name`, `amount`, `expense_date`, `description`, `created_at`) VALUES
(1, 'Specimen Cup', 500.00, '2025-12-02 11:29:00', '2 boxes worth 500 php.', '2025-12-02 11:32:35');
...
(1, 'Chest PA/AP', '', 450.00, 'X-Ray Examinations', 'individual', NULL, 1, '2025-12-01 17:22:36'),
(2, 'Chest APL/PAL Upper & Lower', '', 850.00, 'X-Ray Examinations', 'individual', NULL, 1, '2025-12-01 17:27:24');
